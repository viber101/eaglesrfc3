...
export const MOCK_X_PLAYERS: XPlayer[] = [
  ...
  { id: 'xp6', name: 'Quentine Wejuli', currentClub: 'Currently is an Entrepreneur in Finance, Agric and RealEstate', number: '6', imageUrl: '/our%20x-players/Wejuli%20quinteen.jpeg' },
