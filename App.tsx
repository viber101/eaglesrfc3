...
const HOME_HALL_OF_FAME_IMAGE_BY_NAME: Record<string, string> = {
  ...
  'Osuta Aaron': '/Hall of Fame/Osuta Aaron.jpeg',
...
const HOME_CURRENT_SQUAD_2026_IMAGE_BY_NAME: Record<string, string> = {
  ...
  'Sabunyo Samyl': '/Current Squad 2026/Sabunyo Samuel.jpeg',
...
const PLAYER_PROFILE_OVERRIDES: Record<string, PlayerProfileOverride> = {
  ...
  '53': { name: 'Sabunyo Samyl', age: 25, kgs: 93, cm: 170 },
...
const PLAYER_BIRTHDAYS: PlayerBirthday[] = [
  ...
  { name: 'Samyl Sabunyo', day: 26, month: 1 },
  ...
  <>
    ...
    <section className="mb-12">
      <div className="flex items-end justify-between mb-5">
        <div>
          <p className="text-[10px] uppercase tracking-[0.2em] font-black text-[#f39c12]">Game Week Focus</p>
        ...
        {homeCalendarFixtures.map((fixture) => (
          ...
          >
            <div className="relative px-4 py-3 sm:px-5 sm:py-4 bg-gradient-to-r from-[#081534] via-[#0d245b] to-[#143a8a] text-white border-t-4 border-[#F5A623]">
              ...
              <h4 className="relative mt-1 text-lg sm:text-2xl font-black tracking-tight leading-tight">
                <span className={isEaglesTeam(fixture.home) ? 'text-[#F5A623]' : ''}>{fixture.home}</span>
                <span>{' '}VS{' '}</span>
                <span className={isEaglesTeam(fixture.away) ? 'text-[#F5A623]' : ''}>{fixture.away}</span>
              </h4>
    ...
    <section className="bg-white border border-[#dce4f1] rounded-xl p-6 sm:p-7">
      ...
      <div className="relative overflow-hidden">
        <div className="partner-logo-track flex w-max gap-4">
          <article className="rounded-xl border border-[#e2e7f0] bg-[#f8fbff] p-4 h-24 sm:h-28 w-[220px] flex items-center justify-center shrink-0">
            <img
              loading="lazy"
              decoding="async"
      ...
      <div className="mt-4 space-y-3">
        <details className="group rounded-xl border border-[#e2e7f0] bg-[#f8fbff] p-4 sm:p-5" open>
          <summary className="flex items-center justify-between cursor-pointer list-none">
            ...
            <span className="text-[#4d6185] text-xs font-black uppercase tracking-[0.14em] group-open:rotate-180 transition-transform">More</span>
          </summary>
        ...
        <details className="group rounded-xl border border-[#e2e7f0] bg-[#f8fbff] p-4 sm:p-5">
          <summary className="flex items-center justify-between cursor-pointer list-none">
            <p className="text-sm sm:text-base font-black uppercase tracking-[0.08em] text-[#081534]">Partner Title</p>
            <span className="text-[#4d6185] text-xs font-black uppercase tracking-[0.14em] group-open:rotate-180 transition-transform">More</span>
          </summary>
          <p className="text-sm text-[#1f2f4d] leading-relaxed mt-3">Add partner description here.</p>
        </details>
      </div>
    </section>
